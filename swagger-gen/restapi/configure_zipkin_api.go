...
func configureFlags(api *operations.ZipkinAPIAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.ZipkinAPIAPI) http.Handler {
	...
	if api.PostSpansHandler == nil {
		api.PostSpansHandler = operations.PostSpansHandlerFunc(func(params operations.PostSpansParams) middleware.Responder {
			return middleware.NotImplemented("operation operations.PostSpans has not yet been implemented")
		})
	}
